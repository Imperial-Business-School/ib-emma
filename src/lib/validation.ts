...
// Numeric grade with at most two decimal places. "70" OK, "70.5" OK,
// "70.52" OK, "70.525" not OK. Empty string is also allowed (used to
// clear a grade).
export const GRADE_REGEX_SOURCE = "^\\d+(\\.\\d{1,2})?$";
